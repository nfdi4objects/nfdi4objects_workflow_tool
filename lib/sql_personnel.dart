...
// created_at: the time that the item was created. It will be automatically handled by SQLite
  ...
  static Future<int> createPerson(String personName, String? personPosition, String? personExperience, String? personEmail, String? personFunction, String? personActivityArea, String? personComment,
    ...
    final data = {'institutionNameOut': institutionNameOut,
      'personName': personName, 'personPosition': personPosition, 'personExperience': personExperience, 'personEmail': personEmail, 'personFunction': personFunction, 'personActivityArea': personActivityArea, 'personComment': personComment,
  ...
  static Future<List<Map<String, dynamic>>> getPersons(id) async {
    final db = await SQLPerson.db();
    return db.query('persons', orderBy: "personName");
  }
...
//  }
  ...
  static Future<int> updatePerson(
      int id,
      String institutionNameOut,
      String personName, String? personPosition, String? personExperience, String? personEmail, String? personFunction, String? personActivityArea, String? personComment,
    ...
    final data = {
      'institutionNameOut': institutionNameOut,
